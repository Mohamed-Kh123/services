...
import dashboard from 'nawadash/src/components/basic/dashboard/dashboard'
        ...
        <div class="company-header is-dark-card-bordered is-dark-bg-6 card mb-1">
            <div class="header-item is-dark-bordered-12" v-for="item in data$">
                <div class="item-inner">
                    ...
                    ></i>
                    <small v-if="$get(item,'class')" :class="$get(item,'class')" class="mb-2"
                           style="font-weight: 600;font-size: initial;">
                        {{ $get(item, valueKey) }}
                    </small>
                    <span v-else class="dark-inverted">
                      {{ $get(item, valueKey) }}
                   </span>
                    <p>
                        {{ trans(item.name) }}
