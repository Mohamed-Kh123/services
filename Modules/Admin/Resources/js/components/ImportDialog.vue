...
export default {
    ...
    computed: {
        ...
        routeParams(){
            return _.get(this.$router,'currentRoute.value.params');
        }
    },
    methods: {
        // modal
        ...
        downloadImportSample() {
            console.log('downloadImportSample',this)
            this.downloadSampleLoading = true;
            this.request(
                this.$endPoint(`${this.resource}.sample_import_excel`),
                {
                    params: {
                        no_pagination : true,
                        ...this.routeParams
        ...
        uploadFile() {
            ...
            readXlsxFile(xlsxFile).then((rows) => {
                ...
                var notyf = new Notyf();
                this.request(
                    {method: "POST", url: `/api/admin/${this.resource}/excel/import`},
                    {
                        data,
                    },
                    function (response) {
